...
export type WhiteboardToolIconName =
  | 'select'
  | 'pen'
  | 'highlighter'
  | 'eraser'
...
export interface WhiteboardToolIconProps extends SVGProps<SVGSVGElement> {
  name: WhiteboardToolIconName
}

export function WhiteboardToolIcon({
  name,
  ...props
}: WhiteboardToolIconProps): JSX.Element {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 24 24"
...
const paths: Record<WhiteboardToolIconName, JSX.Element> = {
